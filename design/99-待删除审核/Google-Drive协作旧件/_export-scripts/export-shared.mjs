...
const README_CONTENT = `# AI宠物艺术教育游戏 — 设计文档

> 一款以提升用户艺术感知能力为核心目标的艺术教育类游戏。
...
1. **01-世界观与叙事** — 项目的根基：海难背景、阶段结构、社区愿景
2. **02-角色设计** — 诗人设定与宠物设定
3. **03-视觉风格** — 视觉方向与氛围
4. **04-系统机制** — 审美能量、核心合成、面包纹路、社区机制

## 依赖关系

\`\`\`
世界观与叙事（基础层）
  ├→ 角色设计（角色的叙事背景与阶段结构来自世界观）
  ├→ 系统机制（阶段机制与社区愿景的叙事意义来自世界观）
  └→ 视觉风格（反映角色气质与海岛/海洋氛围）
\`\`\`
